...
export const ContactDialog = forwardRef<HTMLDivElement, ContactDialogProps>(
  function ContactDialog({ isOpen, onClose }, ref) {
    return (
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            >
              <div ref={ref} className="relative w-full max-w-lg apple-dialog p-8 overflow-hidden">
                {/* Glow effect */}
